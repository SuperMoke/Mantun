      ...
      const unsubscribe = onSnapshot(q, async (querySnapshot) => {
        ...
        for (const doc of querySnapshot.docs) {
          ...
          if (!userDoc.empty) {
            ...
            chat.otherParticipantName = userData.fullName || 'Unknown User';
          } else {
  ...
  const renderChatItem = ({ item }) => {
    ...
    return (
      <TouchableOpacity
        ...
        onPress={() => navigation.navigate('ChatScreen_Client', { 
          freelancerId: otherParticipantId, 
          freelancerName: item.otherParticipantName 
        })}
      >
